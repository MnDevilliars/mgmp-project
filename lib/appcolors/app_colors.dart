...
class AppColors {
  // Core Brand Color
  static const Color primary = Color(0xFF006A4E); // Bottle Green

  // Background Colors
  static const Color background = Color(0xFFF1F4F2); // Soft gray-green tint
  static const Color darkBackground = Color(0xFF0F1E1A); // Very dark green for dark mode

  // Text Colors
  static const Color heading = Color(0xFF003D2E); // Deep forest green
  static const Color bodyText = Color(0xFF2E4C45); // Muted green-gray
